...
// prettier-ignore
import { Methods as Methods0 } from './v1/novels'
// prettier-ignore
import { Methods as Methods1 } from './v1/novels/_id@number'
// prettier-ignore
import { Methods as Methods2 } from './v1/novels/_id@number/episodes'
// prettier-ignore
import { Methods as Methods3 } from './v1/novels/_id@number/episodes/_episodeId@number'
// prettier-ignore
import { Methods as Methods4 } from './v1/novels/_id@number/me'
// prettier-ignore
import { Methods as Methods5 } from './v1/users'
// prettier-ignore
import { Methods as Methods6 } from './v1/users/_id@number'
// prettier-ignore
import { Methods as Methods7 } from './v1/users/_id@number/novels'
// prettier-ignore
import { Methods as Methods8 } from './v1/users/me'
        ...
        _id: (val2: number) => {
          ...
          return {
              ...
              _episodeId: (val4: number) => {
                ...
                return {
                  ...
                  put: (option: { body: Methods3['put']['reqBody'], config?: T }) =>
                    fetch<Methods3['put']['resBody'], BasicHeaders, Methods3['put']['status']>(prefix, prefix4, PUT, option).json(),
                  /**
                   * @returns Success
                   */
                  $put: (option: { body: Methods3['put']['reqBody'], config?: T }) =>
                    fetch<Methods3['put']['resBody'], BasicHeaders, Methods3['put']['status']>(prefix, prefix4, PUT, option).json().then(r => r.body),
            ...
            me: {
               ...
               */
              get: (option?: { config?: T }) =>
                fetch<Methods4['get']['resBody'], BasicHeaders, Methods4['get']['status']>(prefix, `${prefix2}${PATH2}`, GET, option).json(),
              /**
               * @returns Success
               */
              $get: (option?: { config?: T }) =>
                fetch<Methods4['get']['resBody'], BasicHeaders, Methods4['get']['status']>(prefix, `${prefix2}${PATH2}`, GET, option).json().then(r => r.body),
          ...
          return {
            novels: {
              ...
              get: (option: { query: Methods7['get']['query'], config?: T }) =>
                fetch<Methods7['get']['resBody'], BasicHeaders, Methods7['get']['status']>(prefix, `${prefix2}${PATH4}`, GET, option).json(),
              /**
               * @returns Success
               */
              $get: (option: { query: Methods7['get']['query'], config?: T }) =>
                fetch<Methods7['get']['resBody'], BasicHeaders, Methods7['get']['status']>(prefix, `${prefix2}${PATH4}`, GET, option).json().then(r => r.body),
